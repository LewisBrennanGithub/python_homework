...
class TestRoom(unittest.TestCase):
    ...
    def test_room__can_make_customer_berserk(self):
        self.room1.add_song_to_playlist(self.songfunk1)
        self.room1.add_guest_to_list(self.guest1)
        self.room1.guest_goes_berserk(self.guest1)
        self.assertEqual("Whoo!", self.guest1.berserk)
        print(self.guest1.berserk)
